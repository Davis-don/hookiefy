...
function Serviceprovider() {
    ...
    useMutation({
      ...
      onSuccess: (result) => {
        ...
        toast.success(
          ...
          {
            description:
              `Welcome ${name}! Please log in to continue.`,
            duration: 5000,
            style: {
              background: '#1a1a2e',
  ...
  const handleGoogleCredential =
    useCallback(
      ...
      // Google mutation intentionally omitted
      // to avoid recreating the callback.
  ...
  const handleGoogleSignup = () => {
    if (!GOOGLE_CLIENT_ID) {
      toast.error(
        ...
        {
          description:
            'Missing VITE_GOOGLE_CLIENT_ID env variable.',
          duration: 5000,
          style: {
            background: '#1a1a2e',
            border:
