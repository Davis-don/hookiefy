...
import DefaultFeed from '../../components/defaultfeed/DefaultFeed';
import DefaultLogin from '../../components/defaultlogin/DefaultLogin';
import DefaultSignup from '../../components/defaultsignup/DefaultSignup';
