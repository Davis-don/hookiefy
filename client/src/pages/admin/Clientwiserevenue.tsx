...
function Clientwiserevenue() {
  ...
  return (
    <div className="cwr-overall-container">
      <div className="cwr-header">
        <h3>Client Revenue Overview</h3>
        <div className="cwr-year-selector-wrapper">
          <select
            className="cwr-year-dropdown"
            value={selectedYear}
      ...
      {hasData ? (
        <ResponsiveContainer width="100%" height={350}>
          <LineChart data={currentData}>
            ...
            <defs>
              <linearGradient id="cwrRevenueGradient" x1="0" y1="0" x2="0" y2="1">
              ...
              <linearGradient id="cwrRevenueGradientGlow" x1="0" y1="0" x2="0" y2="1">
            ...
            <Area
              ...
              dataKey="amount"
              stroke="none"
              fill="url(#cwrRevenueGradientGlow)"
              fillOpacity={0.5}
            />
        ...
        <div className="cwr-no-data-message">
...
export default Clientwiserevenue;